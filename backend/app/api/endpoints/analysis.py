...
@router.get("/projects/{project_id}/comparison", response_model=schemas.ComparisonResponse)
async def get_comparison_table(
    ...
    try:
        return await comparison_service.generate_comparison(project_id=project_id, db=db)
